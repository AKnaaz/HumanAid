...
const router = createBrowserRouter([
  {
    ...
    children: [
        ...
        },
        {
          ...
          loader: () => fetch("https://my-eleventh-assignment-server-mauve.vercel.app/vols"),
        ...
        {
          path: "/vols/:id",
          loader: ({params}) => fetch(`https://my-eleventh-assignment-server-mauve.vercel.app/vols/${params.id}`, {
            credentials: 'include'
          }),
          element: <PrivateRoute>
